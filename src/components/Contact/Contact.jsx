            ...
            <div className="st-contact-info-wrap">
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Email</h4>
                  <Link to="mail:arifhossain.mern@gmail.com">arifhossain.mern@gmail.com</Link>
                  <Link to="mail:info@trackingbygtm.com">info@trackingbygtm.com</Link>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
                ...
                <div className="st-single-info-details">
                  <h4>Phone</h4>
                  <span><a target='_blank' href="https://wa.me/8801749827904">+88 0174-9827904</a></span>
                  <span><a target='_blank' href="https://wa.me/8801738612417">+88 0173-8612417</a></span>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
